...
import net.thevpc.app.vainruling.VrInstallDemo;
...
import net.thevpc.app.vainruling.plugins.equipments.aquisition.model.EquipmentAquisitionLog;
import net.thevpc.app.vainruling.plugins.equipments.aquisition.service.EquipmentAcquisitionService;
...
import net.thevpc.app.vainruling.plugins.equipments.core.model.EquipmentBrandLine;
...
import net.thevpc.app.vainruling.plugins.equipments.core.model.EquipmentTypeGroup;
import net.thevpc.app.vainruling.plugins.equipments.core.model.Equipment;
import net.thevpc.app.vainruling.plugins.equipments.core.model.EquipmentProperty;
import net.thevpc.app.vainruling.plugins.equipments.core.model.EquipmentBrand;
...
//        core.profileAddRight(headOfDepartment.getId(),AcademicPluginSecurity.RIGHT_CUSTOM_EDUCATION_MY_COURSE_LOAD);
        ...
        for (net.thevpc.upa.Entity ee : UPA.getPersistenceUnit().getPackage("Equipment").getEntities(true)) {

...
public class AllTeachersCourseLoadCtrl {
    ...
    private static final Logger LOG = Logger.getLogger(AllTeachersCourseLoadCtrl.class.getName());
    ...
    public void onChangePeriod() {
        try {
            ...
            refreshableFilters.add(FacesUtils.createSelectItem("proposal", "Inclure Propositions", "vr-checkbox"));
    ...
    public void onRefresh() {
        try {
            ...
            if (periodId >= -1) {
                ...
                KeyValueList<Integer, TeacherPeriodStat> year = a.evalTeacherStatList(periodId, customTeacherFilter, filter, deviationConfig, null);

...
import net.thevpc.app.vainruling.plugins.academic.model.internship.AcademicInternshipCount;
...
public class InternshipBoardsStatsCtrl /*extends MyInternshipBoardsCtrl*/ {
    ...
    public void onRefreshListMode() {
        ...
        if (currentTeacher != null) {
            ...
            if (boardId == -1) {
                internshipTypeId = StringUtils.isBlank(getModel().getFilterInternshipTypeId()) ? -1 : Integer.valueOf(getModel().getFilterInternshipTypeId());
            }

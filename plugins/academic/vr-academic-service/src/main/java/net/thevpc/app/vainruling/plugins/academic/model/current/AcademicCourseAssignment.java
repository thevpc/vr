...
//            @Property(name = UIConstants.Form.SEPARATOR, value = "Trace"))
    ...
    public String toString() {
        return "AcademicCourseAssignment{" + "id=" + id + ", name=" + name + ", name2=" + name2 + ", teacher=" + teacher + ", valueC=" + valueC + ", valueTD=" + valueTD + ", valueTP=" + valueTP + ", valuePM=" + valuePM + ", valueEffWeek=" + valueEffWeek + ", groupCount=" + groupCount + ", courseType=" + courseType + ", coursePlan=" + coursePlan + '}';
    }

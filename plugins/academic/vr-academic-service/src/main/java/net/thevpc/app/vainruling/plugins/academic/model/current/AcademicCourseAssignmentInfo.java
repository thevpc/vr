...
//    }
    ...
    public LoadValue getLoadValue(){
        double c = assignment.getValueC();
        double td = assignment.getValueTD();
        double tp = assignment.getValueTP();
        double pm = assignment.getValuePM();
        double g = assignment.getGroupCount();
        return new LoadValue(c*g, td*g, tp*g, pm*g);
    }

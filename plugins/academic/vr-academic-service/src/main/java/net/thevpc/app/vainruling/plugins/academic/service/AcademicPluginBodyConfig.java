...
public class AcademicPluginBodyConfig extends AcademicPluginBody {
    ...
    public void onStart() {
        ...
        for (net.thevpc.upa.Entity ee : pu.getPackage("Education").getEntities(true)) {
...
//    }
    ...
    public List<AcademicCourseCore> findAcademicCourseCores(Integer periodId,Integer programId) {
        return UPA.getPersistenceUnit().
                createQueryBuilder(AcademicCourseCore.class).setEntityAlias("a")
                .byExpression("a.programId=:programId",programId!=null)
                .byExpression("a.periodId=:periodId",periodId!=null)

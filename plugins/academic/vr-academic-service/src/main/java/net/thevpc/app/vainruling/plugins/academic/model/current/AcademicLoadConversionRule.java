...
public class AcademicLoadConversionRule {
...
//            @Property(name = UIConstants.Form.SEPARATOR, value = "Trace"))
    @Field(updateProtectionLevel = ProtectionLevel.PROTECTED,excludeModifiers = UserFieldModifier.UPDATE)
    ...
    public AcademicLoadConversionRule(int id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public String toString() {
        return "AcademicLoadConversionRule{" +
                "id=" + id +
                ", name='" + name + '\'' +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AcademicLoadConversionRule)) return false;

        AcademicLoadConversionRule that = (AcademicLoadConversionRule) o;

...
import net.thevpc.app.vainruling.plugins.academic.service.integration.TeacherGenerationHelper;
...
import net.thevpc.app.vainruling.plugins.academic.model.current.AcademicCourseAssignment1;
import net.thevpc.app.vainruling.plugins.academic.model.current.AcademicCourseAssignment2;
...
//            }
    ...
    public KeyValueList<Integer, AcademicCourseAssignment> findCourseAssignments(int periodId, CourseAssignmentFilter filter) {
        KeyValueList<Integer, AcademicCourseAssignment> courseAssignments = findCourseAssignments(periodId);
        if (filter == null) {
            return courseAssignments;
        }
        KeyValueList<Integer, AcademicCourseAssignment> m = Collections2.keyValueList(
    ...
    public KeyValueList<Integer, AcademicCourseAssignment> findCourseAssignments(int periodId) {
        return cacheService.get(AcademicCourseAssignment.class)
                .getProperty("findCourseAssignments:" + periodId, new Action<KeyValueList<Integer, AcademicCourseAssignment>>() {
                    @Override
                    public KeyValueList<Integer, AcademicCourseAssignment> run() {
                        ...
                        return CollectionUtils.unmodifiableMapList(Collections2.<Integer, AcademicCourseAssignment>keyValueList(
                                academicCourseAssignmentIdConverter
                        ).appendAll(assignments));
                    }
                });
    }

...
public class DefaultTeacherPeriodFilter implements TeacherPeriodFilter {
    ...
    private final Set<Integer> acceptedCourseCores = new HashSet<>();
    ...
    private final Set<Integer> rejectedCourseCores = new HashSet<>();
    ...
    public boolean acceptCourseCore(AcademicCourseCore officialDiscipline) {
        if (!acceptedCourseCores.isEmpty() && !acceptedCourseCores.contains(officialDiscipline == null ? null : officialDiscipline.getId())) {
            return false;
        }
        if (!rejectedCourseCores.isEmpty() && rejectedCourseCores.contains(officialDiscipline == null ? null : officialDiscipline.getId())) {
            return false;
        }
        return true;
    }
    ...
    public DefaultTeacherPeriodFilter addAcceptedCourseCore(Integer id) {
        acceptedCourseCores.add(id);
        return this;
    }
    ...
    public DefaultTeacherPeriodFilter addRejectedCourseCore(Integer id) {
        rejectedCourseCores.add(id);
        return this;
    }
    ...
    public DefaultTeacherPeriodFilter removeAcceptedCourseCore(Integer id) {
        acceptedCourseCores.remove(id);
        return this;
    }

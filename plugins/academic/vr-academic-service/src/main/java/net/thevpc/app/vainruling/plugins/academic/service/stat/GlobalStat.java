...
public class GlobalStat {
    ...
    public static final Function<String, DisciplineStat> V_MAP_VALUE_FACTORY_LOAD_VALUE = new Function<String, DisciplineStat>(){
        @Override
        public DisciplineStat apply(String key) {
...
//    private int teachersOtherCount;
    ...
    private AutoValueMap<String, DisciplineStat> nonPermanentLoadValueByNonOfficialDiscipline = Collections2.autoValueHashMap(V_MAP_VALUE_FACTORY_LOAD_VALUE);
    private AutoValueMap<String, DisciplineStat> nonPermanentLoadValueByOfficialDiscipline = Collections2.autoValueHashMap(V_MAP_VALUE_FACTORY_LOAD_VALUE);
    private AutoValueMap<String, DisciplineStat> permanentLoadValueByNonOfficialDiscipline = Collections2.autoValueHashMap(V_MAP_VALUE_FACTORY_LOAD_VALUE);
    private AutoValueMap<String, DisciplineStat> permanentLoadValueByOfficialDiscipline = Collections2.autoValueHashMap(V_MAP_VALUE_FACTORY_LOAD_VALUE);
    /**
    ...
    public AutoValueMap<String, DisciplineStat> getNonPermanentLoadValueByNonOfficialDiscipline() {
        return nonPermanentLoadValueByNonOfficialDiscipline;
    }

    public AutoValueMap<String, DisciplineStat> getNonPermanentLoadValueByOfficialDiscipline() {
        return nonPermanentLoadValueByOfficialDiscipline;
    }

    public AutoValueMap<String, DisciplineStat> getPermanentLoadValueByNonOfficialDiscipline() {
        return permanentLoadValueByNonOfficialDiscipline;
    }

    public AutoValueMap<String, DisciplineStat> getPermanentLoadValueByOfficialDiscipline() {

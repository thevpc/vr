 ...
 */
public class CourseOptionsRanking_EI_lundi {
    ...
    private int nbModulesByOptions = 0;
    private final String USER_HOME_DATA_ENISO_STUDENTS_2015_2016 = "${user.home}/Data/eniso/students/2016-2017/choix-options/EI";///old/v01

    private String file_principal = USER_HOME_DATA_ENISO_STUDENTS_2015_2016 + "/2EIPRINC.xlsx";
    private String file_rattrapage = USER_HOME_DATA_ENISO_STUDENTS_2015_2016 + "/2EIRATT.xlsx";
    private String file_intermediaire = USER_HOME_DATA_ENISO_STUDENTS_2015_2016 + "/2EI-FOR-OPTION.xlsx";
    private String file_result = USER_HOME_DATA_ENISO_STUDENTS_2015_2016 + "/2EI-OPTIONS-FINAL.xlsx";
...
//            }
    ...
    private double evalGlobalScore(StudentInfo o1) {
        ...
        double v= (o1.moyg + bonus_mastere * Math.max(o1.master - 10, 0))*(o1.redoublement?(1- penal_redoulement):1);
        if (o1.rattr) {
            v -= 10;
        }
        return v;
...
//        return v;
    ...
    public static void main(String[] args) {
        CourseOptionsRanking_EI_lundi c = new CourseOptionsRanking_EI_lundi();
//        generateOptionsFile();
    ...
    public void generateOptionsFile() {
        try {
            ...
            Logger.getLogger(CourseOptionsRanking_EI_lundi.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                        System.out.println(cc[0] + ";" + cc[1]+ ";" + cc[2] +" ==> "+cc2[0] + ";" + cc2[1]+ ";" + cc2[2]);
            ...
            int[] maxOptions = new int[]{maxOption, maxOption, maxOption};

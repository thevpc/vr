...
import net.vpc.app.vainruling.plugins.academic.service.dto.PlanningActivitySerializable;
...
import net.vpc.app.vainruling.plugins.academic.model.internship.planning.FitnessValue;
import net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningActivityTableExt;
import net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningFitnessFunction;
import net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningInternship;
import net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningMutationOperator;
import net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningRoom;
import static net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningService.EVOLUTION_SIZE;
import static net.vpc.app.vainruling.plugins.academic.model.internship.planning.PlanningService.MAX_ALLOWED_EVOLUTIONS;
...
import net.vpc.app.vainruling.plugins.academic.service.dto.PlanningActivityTableSerializable;
import net.vpc.app.vainruling.plugins.academic.service.dto.PlanningTimeSerializable;

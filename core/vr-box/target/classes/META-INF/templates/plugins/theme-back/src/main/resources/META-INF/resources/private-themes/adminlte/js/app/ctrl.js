...
var MailData = makeStruct("toAll toEach cc bcc subject text attachments");


angular.module('app').controller("IndexCtrl", function () {
    var vm = this;
    vm.userName = 'Taha';
    vm.curr = new MailData();
    vm.submit_data = function () {
        $.ajax({
            url: "/vain-ruling-service/resources/mail/updateForm",
            type: "get",
            data: 'a=' + JSON.stringify({MailData: vm.curr}),

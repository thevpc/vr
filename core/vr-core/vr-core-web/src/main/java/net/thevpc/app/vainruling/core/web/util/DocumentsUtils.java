...
//    }
    ...
    private static class WildcardFileFilter implements VFileFilter {
        ...
        public WildcardFileFilter(String str) {
            p = Pattern.compile(wildcardToRegex(net.thevpc.common.strings.StringUtils.normalizeString(str)));
        }

        @Override
        public boolean accept(VFile pathname) {
            return p.matcher(net.thevpc.common.strings.StringUtils.normalizeString(pathname.getName())).matches();
        }
    }

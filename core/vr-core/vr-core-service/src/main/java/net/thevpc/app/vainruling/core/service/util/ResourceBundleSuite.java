...
public class ResourceBundleSuite {
    ...
    private String format0(String message, final int maxDepth, Map<String,Object> params) {
        ...
        if (params!=null && params.size() > 0) {
            message = new MessageNameFormat(message).format(params,new MessageNameFormatContext());
        }
        return message;
    }
    ...
    private String format0(String message, final int maxDepth, Arg... params) {
        ...
        if (params.length > 0) {
            ...
            message = new MessageNameFormat(message).format(paramsMap,new MessageNameFormatContext());
        }
        return message;
    }
}

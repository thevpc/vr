...
//            @Property(name = UIConstants.Form.SEPARATOR, value = "Trace"))
    ...
    public boolean equals(Object o) {
        ...
        if (includeSender != that.includeSender) {
            return false;
        }
        if (noSubject != that.noSubject) {
            return false;
        }
        ...
        if (disposition != null ? !disposition.equals(that.disposition) : that.disposition != null) {
            return false;
        }
        ...
        if (linkURL != null ? !linkURL.equals(that.linkURL) : that.linkURL != null) {
            return false;
        }
        if (decoration != null ? !decoration.equals(that.decoration) : that.decoration != null) {
            return false;
        }
        ...
        if (deletedBy != null ? !deletedBy.equals(that.deletedBy) : that.deletedBy != null) {
            return false;
        }

...
@FacesConverter("vpcDateTimeConverter")
public class VpcDateTimeConverter implements Converter{
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        ...
        try {
            ...
            return new net.thevpc.upa.types.DateTime(f.parse(string).getTime());

...
public class VrConfigureInstall {
    ...
    public boolean isMandatoryConfig(ServletContext servletContext) {
        if (servletContext.getAttribute("/META-INF/Installed") != null) {
            return false;
        }
        String rp = servletContext.getRealPath("/") + "/META-INF/private/install.lock";
...
//        servletContext.setAttribute("/META-INF/Installed", true);
        return "/login";
    }
